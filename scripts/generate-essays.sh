...
DATA_FILE="$ROOT_DIR/content/essay-metadata.csv"
OUT_DIR="$ROOT_DIR/essays"
...
while IFS='|' read -r slug section title publish_date lede body_mode; do
  [[ -z "$slug" ]] && continue
  [[ "$body_mode" != "generated" ]] && continue

  pubdate="$(format_date "$publish_date")"
    ...
    <div class="page-wrapp min-height">
      <div class="page-contain less essay-page">
        ...
        <div class="content-block">
          <div class="page-subheading top essay-date">${pubdate}</div>
        ...
        <div class="content-block essay-content">
          <p><em>"${lede}"</em></p>
          <p>
            Most advice sounds obvious until you apply it under real pressure. The gap between
            knowing and doing is where outcomes are won.
          </p>
          <p>
            In this essay, I am not chasing perfect theory. I am sharing a practical playbook you
            can use this week, with your current team, budget, and constraints.
          </p>
          <p>
            Start with one clear move. Define the smallest meaningful win. Ship that. Then repeat.
            Compounding is usually boring in the beginning and obvious in retrospect.
          </p>
          <p>
            If something feels unclear, reduce scope. If it feels heavy, simplify ownership. If it
            feels slow, cut decisions into smaller checkpoints.
          </p>
          <p>
            The best operators are not always the smartest in the room. They are the people who
            can translate ambiguity into steady execution.
          </p>
          <p>
            Build systems your future self can trust. Protect attention. Keep promises to yourself.
            That is how durable momentum is built.
          </p>
          <p>
            - dr. calculus
          </p>
...
echo "Generated essay pages in $OUT_DIR"
